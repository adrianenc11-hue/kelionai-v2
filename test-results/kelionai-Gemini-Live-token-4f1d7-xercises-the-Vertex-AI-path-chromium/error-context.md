...
- Name: kelionai.spec.js >> Gemini Live token endpoint (Stage 1 precondition) >> Forcing ?backend=vertex exercises the Vertex AI path
- Location: e2e\kelionai.spec.js:131:3
...
Call log:
  - → GET http://127.0.0.1:5173/api/realtime/gemini-token?lang=en-US&backend=vertex
