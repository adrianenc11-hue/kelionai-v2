...
- Name: kelionai.spec.js >> Frontend shell >> GET /studio serves the SPA shell so client router can mount KelionStudio
- Location: e2e\kelionai.spec.js:72:3
...
Call log:
  - → GET http://127.0.0.1:5173/studio
