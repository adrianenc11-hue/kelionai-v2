...
- Name: kelionai.spec.js >> Kelion Studio API (DS-1 / DS-3) wiring >> GET /api/studio/usage rejects anonymous callers with JSON 401
- Location: e2e\kelionai.spec.js:86:3
...
Call log:
  - → GET http://127.0.0.1:5173/api/studio/usage
