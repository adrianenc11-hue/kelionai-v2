...
- Name: kelionai.spec.js >> Server health >> GET /api/nonexistent returns JSON 404
- Location: e2e\kelionai.spec.js:42:3
...
Call log:
  - → GET http://127.0.0.1:5173/api/nonexistent-endpoint
