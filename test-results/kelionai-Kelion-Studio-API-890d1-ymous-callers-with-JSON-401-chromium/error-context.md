...
- Name: kelionai.spec.js >> Kelion Studio API (DS-1 / DS-3) wiring >> GET /api/studio/workspaces rejects anonymous callers with JSON 401
- Location: e2e\kelionai.spec.js:99:3
...
Call log:
  - → GET http://127.0.0.1:5173/api/studio/workspaces
