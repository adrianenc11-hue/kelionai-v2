...
- Name: kelionai.spec.js >> Frontend shell >> Unknown route serves the SPA shell (client-side router takes over)
- Location: e2e\kelionai.spec.js:60:3
...
Call log:
  - → GET http://127.0.0.1:5173/definitely-not-a-route-xyz
