...
const TOOL_DEFINITIONS = [
  ...
  },
  {
    ...
    description:
      "Get cryptocurrency/stock trading analysis, signals, and market intelligence.",
    input_schema: {
      type: "object",
      properties: {},
    },
  ...
  },
  {
    name: "get_legal_info",
    description:
      "Get legal information: terms of service, privacy policy, GDPR, refund policy.",
    input_schema: {
      type: "object",
      properties: {
        document: {
          type: "string",
          description:
            "Which document: 'terms', 'privacy', 'gdpr', 'refund', 'cookie'",
        },
      },
      required: ["document"],
    },
    ...
    input_schema: {
      ...
      properties: {
        code: {
          type: "string",
          description:
            "JavaScript code to execute. Must return a value or use console.log().",
        },
      },
      required: ["code"],
    },
    ...
    input_schema: {
      ...
      properties: {
        ...
        filters: {
          type: "string",
          description:
            "Filter conditions, e.g. 'status=active' or 'created_at>2024-01-01'",
        },
        limit: {
          type: "number",
    ...
    input_schema: {
      ...
      properties: {
        material: {
          type: "string",
          description:
            "Material type: 'metal', 'composite', 'ceramic', 'plastic', 'weld', 'pcb', 'unknown'",
        },
        method: {
          type: "string",
          description:
            "NDT method: 'visual', 'xray', 'ultrasound', 'thermal', 'magnetic', 'eddy_current'",
        },
      },
      required: ["method"],
    },
    ...
    input_schema: {
      ...
      properties: {
        component: {
          type: "string",
          description:
            "Component name or part number, e.g. 'LM7805', 'ATmega328', '100nF capacitor'",
        },
        info: {
          type: "string",
          description:
            "What info: 'datasheet', 'pinout', 'alternatives', 'specs', 'pricing'",
        },
      },
      required: ["component"],
    },
    ...
    input_schema: {
      ...
      properties: {
        modality: {
          type: "string",
          description:
            "Imaging modality: 'mri', 'ct', 'pet', 'xray', 'ultrasound', 'mammography'",
        },
        body_region: {
          type: "string",
          description:
        ...
        focus: {
          type: "string",
          description:
            "Analysis focus: 'anatomy', 'anomaly_detection', 'measurements', 'comparison', 'full_report'",
        },
      },
      required: ["modality"],
    },
    ...
    input_schema: {
      ...
      properties: {
        query: {
          type: "string",
          description:
            "Search query, e.g. 'BRCA1 breast cancer treatment 2024', 'MRI glioblastoma detection'",
        },
        max_results: {
          type: "number",
    ...
    input_schema: {
      ...
      properties: {
        ...
        constraints: {
          type: "string",
          description:
            "Design constraints, e.g. 'max 5V, <100mA, medical grade, -20 to +70C'",
        },
      },
    ...
    input_schema: {
      ...
      properties: {
        action: {
          type: "string",
          description:
            "Action: 'create', 'update', 'add_section', 'add_measurement', 'export'",
        },
        title: {
          type: "string",
          description:
            "Manual title, e.g. 'Linear Accelerator QA Protocol', 'MRI Daily Checks'",
        },
        section: {
          type: "string",
          description:
        ...
        content: {
          type: "string",
          description:
            "Content to add: measurement results, limits, procedures, notes",
        },
      },
    ...
    input_schema: {
      ...
      properties: {
        action: {
          type: "string",
          description:
            "Action: 'record', 'check_limits', 'trend', 'report', 'history', 'calibration'",
        },
        equipment: {
          type: "string",
          description:
            "Equipment name/ID, e.g. 'Linac-1', 'MRI-Siemens-3T', 'Osciloscop-Rigol'",
        },
        parameter: {
          type: "string",
          description:
            "What was measured: 'output_dose', 'voltage', 'frequency', 'temperature', 'field_uniformity'",
        },
    ...
    input_schema: {
      ...
      properties: {
        action: {
          type: "string",
          description:
            "Action: 'draft' (preview), 'send' (send now), 'reply' (reply to last)",
        },
    ...
    input_schema: {
      ...
      properties: {
        action: {
          type: "string",
          description:
            "Action: 'create', 'list', 'update', 'delete', 'today', 'week', 'find_free', 'remind'",
        },
  ...
  },
  {
    name: "task_manager",
    description:
      "Manage tasks and TODO lists. Create, update, complete, prioritize, assign tasks. Track deadlines, organize by project/category.",
    input_schema: {
      type: "object",
      properties: {
        action: {
        ...
        deadline: {
          type: "string",
          description:
            "Deadline: 'YYYY-MM-DD' or 'today', 'tomorrow', 'next_week'",
        },
    ...
    input_schema: {
      ...
      properties: {
        action: {
          type: "string",
          description:
            "Action: 'add', 'search', 'update', 'delete', 'list', 'categorize'",
        },
        ...
        category: {
          type: "string",
          description:
            "Category: 'client', 'supplier', 'colleague', 'personal', 'medical', 'government'",
        },
        notes: { type: "string", description: "Additional notes" },
      },
      required: ["action"],
    ...
    input_schema: {
      ...
      properties: {
        ...
        from: {
          type: "string",
          description:
            "Source language: 'ro', 'en', 'de', 'fr', 'es', 'it', 'hu', 'auto'",
        },
        to: {
          type: "string",
          description:
            "Target language: 'ro', 'en', 'de', 'fr', 'es', 'it', 'hu'",
        },
        style: {
          type: "string",
          description:
            "Style: 'formal', 'casual', 'technical', 'legal', 'medical'",
        },
      },
      required: ["text", "to"],
    },
    ...
    input_schema: {
      ...
      properties: {
        ...
        style: {
          type: "string",
          description:
            "Style: 'bullet_points', 'executive_summary', 'action_items', 'key_decisions', 'full'",
        },
        length: {
          type: "string",
          description:
            "Length: 'short' (1-3 sentences), 'medium' (paragraph), 'detailed' (full page)",
        },
      },
      required: ["text", "style"],
    },
    ...
    input_schema: {
      ...
      properties: {
        ...
        action: {
          type: "string",
          description:
            "Action: 'create', 'modify', 'analyze' (if image uploaded)",
        },
        style: {
          type: "string",
          description:
            "Style: 'technical', 'simple', 'detailed', 'presentation'",
        },
      },
    ...
    input_schema: {
      ...
      properties: {
        ...
        formulas: {
          type: "string",
          description:
            "Excel formulas or calculations needed: 'SUM', 'AVERAGE', 'total', 'subtotals'",
        },
      },
      required: ["title", "type"],
    },
    ...
    input_schema: {
      ...
      properties: {
        ...
        audience: {
          type: "string",
          description:
            "Target audience: 'executives', 'technical', 'students', 'clients', 'medical_staff'",
        },
        style: {
          type: "string",
          description:
            "Style: 'professional', 'educational', 'pitch', 'report', 'training'",
        },
        language: {
          type: "string",
          description: "Language: 'ro', 'en', 'de', 'fr'",
    ...
    input_schema: {
      ...
      properties: {
        input_format: {
          type: "string",
          description:
            "Input format: 'text', 'markdown', 'csv', 'json', 'html', 'table'",
        },
        output_format: {
          type: "string",
          description:
            "Output format: 'html', 'markdown', 'csv', 'json', 'table', 'excel_formula'",
        },
    ...
    input_schema: {
      ...
      properties: {
        board_type: {
          type: "string",
          description:
            "Board type: 'smt', 'through_hole', 'mixed', 'bga', 'flex', 'rigid_flex'",
        },
        class: {
          type: "string",
          description:
            "IPC class: 'class1' (consumer), 'class2' (industrial), 'class3' (high-rel/medical/military)",
        },
        focus: {
          type: "string",
          description:
    ...
    input_schema: {
      ...
      properties: {
        domain: {
          type: "string",
          description:
            "Domain: 'electronics', 'building', 'mechanical', 'electrical', 'medical', 'solar_panel'",
        },
        focus: {
          type: "string",
          description:
    ...
    input_schema: {
      ...
      properties: {
        microscope_type: {
          type: "string",
          description:
            "Type: 'optical', 'sem', 'tem', 'fluorescence', 'metallurgical', 'stereo', 'confocal'",
        },
        sample: {
          type: "string",
          description:
            "Sample type: 'metal', 'semiconductor', 'biological', 'polymer', 'ceramic', 'composite', 'pcb'",
        },
        magnification: {
          type: "string",
          description:
            "Magnification level if known: '10x', '100x', '1000x', '10000x'",
        },
        focus: {
          type: "string",
          description:
    ...
    input_schema: {
      ...
      properties: {
        ...
        standard: {
          type: "string",
          description:
            "Quality standard: 'iso9001', 'iec62368', 'iec60601' (medical), 'mil_std', 'custom'",
        },
        criteria: {
          type: "string",
    ...
    input_schema: {
      ...
      properties: {
        context: {
          type: "string",
          description:
            "Context: 'before_after', 'golden_vs_production', 'reference_vs_actual', 'revision_comparison'",
        },
        focus: {
          type: "string",
          description:
            "What to compare: 'dimensions', 'components', 'surface', 'color', 'layout', 'full'",
        },
      },
      required: ["context"],
    },
    ...
    input_schema: {
      ...
      properties: {
        ...
        topic: {
          type: "string",
          description:
            "Specific topic, e.g. 'Ecuatii de gradul 2', 'Legile lui Newton', 'Romantismul'",
        },
        question_count: {
          type: "number",
    ...
    input_schema: {
      ...
      properties: {
        ...
        grade_level: {
          type: "string",
          description:
            "Grade: 'clasa1', 'clasa5', 'clasa9', 'year7', 'grade10'",
        },
    ...
    input_schema: {
      ...
      properties: {
        subject: {
          type: "string",
          description:
            "Subject: 'math', 'physics', 'chemistry', 'engineering', 'electronics', 'statistics'",
        },
        topic: {
          type: "string",
          description:
            "Topic, e.g. 'integrals', 'circuit analysis', 'stoichiometry', 'beam deflection'",
        },
        count: {
          type: "number",
        ...
        difficulty: {
          type: "string",
          description:
            "Difficulty: 'easy', 'medium', 'hard', 'competition', 'olympiad'",
        },
        show_solution: {
          type: "boolean",
        ...
        level: {
          type: "string",
          description:
            "Level: 'school', 'highschool', 'university', 'postgrad'",
        },
      },
    ...
    input_schema: {
      ...
      properties: {
        ...
        parameters: {
          type: "string",
          description:
            'JSON parameters, e.g. \'{"amount": 100000, "rate": 5.5, "years": 30, "currency": "RON"}\'',
        },
      },
      required: ["calculation", "parameters"],
    },
    ...
    input_schema: {
      ...
      properties: {
        ...
        car: {
          type: "string",
          description:
            "Car make/model/year, e.g. 'Dacia Duster 2022', 'BMW 320d 2019'",
        },
        symptom: {
          type: "string",
          description:
            "Symptom description, e.g. 'engine shaking at idle', 'squeaking brakes'",
        },
      },
      required: ["action"],
    },
    ...
    input_schema: {
      ...
      properties: {
        ...
        context: {
          type: "string",
          description:
            "Additional context, e.g. 'web application', 'api', 'mobile app', 'iot device'",
        },
      },
    ...
    input_schema: {
      ...
      properties: {
        ...
        platform: {
          type: "string",
          description:
            "Platform: 'google', 'facebook', 'instagram', 'tiktok', 'linkedin', 'youtube', 'twitter'",
        },
    ...
    input_schema: {
      ...
      properties: {
        ...
        goal: {
          type: "string",
          description:
            "Goal: 'lose_weight', 'gain_muscle', 'maintain', 'endurance', 'flexibility'",
        },
      },
      required: ["action"],
    },
    ...
    input_schema: {
      ...
      properties: {
        action: {
          type: "string",
          description:
            "Action: 'generate', 'scale', 'substitute', 'meal_plan', 'nutrition', 'shopping_list'",
        },
        ingredients: {
          type: "string",
        ...
        cuisine: {
          type: "string",
          description:
            "Cuisine: 'romaneasca', 'italian', 'asian', 'mexican', 'french', 'mediterranean', 'any'",
        },
        diet: {
          type: "string",
          description:
    ...
    input_schema: {
      ...
      properties: {
        ...
        instrument: {
          type: "string",
          description:
            "Instrument: 'piano', 'guitar', 'bass', 'ukulele', 'violin', 'any'",
        },
      },
      required: ["action"],
    },
    ...
    input_schema: {
      ...
      properties: {
        ...
        material: {
          type: "string",
          description:
            "Material: 'pla', 'abs', 'petg', 'tpu', 'nylon', 'resin', 'pc', 'asa'",
        },
        problem: {
          type: "string",
    ...
    input_schema: {
      ...
      properties: {
        ...
        crop: {
          type: "string",
          description:
            "Crop: 'wheat', 'corn', 'sunflower', 'rapeseed', 'potato', 'tomato', 'grape', 'apple', 'any'",
        },
        location: { type: "string", description: "Location/region" },
        soil_type: {
          type: "string",
          description:
            "Soil type: 'clay', 'sandy', 'loam', 'silt', 'chalky', 'peat'",
        },
  ...
  try {
    switch (toolName) {
      ...
      case "analyze_schematic": {
        ...
        return (
          (await brain._vision(
            brain._currentMediaData.imageBase64,
            userId,
          )) || { analysis: prompt }
        );
      }
      ...
      case "analyze_medical_image": {
        if (!brain._currentMediaData?.imageBase64)
          return {
            error:
              "No medical image uploaded. Please upload an MRI/CT/X-ray image.",
          };
      ...
      case "dose_calculator": {
        try {
          ...
          if (calc === "fractionation") {
            const totalDose =
              (params.dose_per_fraction || 2) * (params.fractions || 30);
            const BED =
              totalDose *
              (1 + (params.dose_per_fraction || 2) / (params.alpha_beta || 10));
            result = {
            ...
            const activity =
              ...
              Math.pow(
                0.5,
                (params.time_hours || 0) / (params.half_life_hours || 6),
              );
            result = {
              remaining_activity: activity.toFixed(2),
              unit: params.unit || "MBq",
              decay_factor: (
                activity / (params.initial_activity || 100)
              ).toFixed(4),
            };
          } else if (calc === "inverse_square") {
            const newDose =
              ((params.dose || 100) * Math.pow(params.distance1 || 1, 2)) /
              Math.pow(params.distance2 || 2, 2);
            result = {
            ...
            result = {
              error:
                "Unknown calculation type. Use: fractionation, decay, inverse_square",
            };
          }
          result.disclaimer =
            "⚠️ EDUCATIONAL ONLY — not for clinical treatment planning";
          return result;
        } catch (calcErr) {
      ...
      case "analyze_oscilloscope": {
        if (!brain._currentMediaData?.imageBase64)
          return {
            error:
              "No oscilloscope screenshot uploaded. Please upload a waveform image.",
          };
      ...
      case "circuit_improvement": {
        let context = "";
        if (brain._currentMediaData?.imageBase64) {
          const visionResult = await brain._vision(
            brain._currentMediaData.imageBase64,
            userId,
          );
          context =
        ...
        return {
          circuit_analysis:
            context || "No schematic image provided — working from description",
      ...
      case "create_technical_manual": {
        ...
        if (
          ...
          if (toolInput.section && toolInput.content) {
            manual.sections[toolInput.section] =
              manual.sections[toolInput.section] || [];
          ...
          await brain.supabaseAdmin
            .from("user_preferences")
            .upsert(
              { user_id: userId || "system", key: manualKey, value: manual },
      ...
      case "measurement_log": {
        ...
        if (toolInput.action === "record") {
          ...
          if (
            toolInput.limit_min !== undefined ||
            toolInput.limit_max !== undefined
          ) {
            entry.limit_min = toolInput.limit_min;
            entry.limit_max = toolInput.limit_max;
            entry.status =
              (toolInput.limit_min !== undefined &&
                toolInput.value < toolInput.limit_min) ||
              (toolInput.limit_max !== undefined &&
                toolInput.value > toolInput.limit_max)
                ? "FAIL"
                : "PASS";
          }
          log.measurements.push(entry);
          if (log.measurements.length > 500)
            log.measurements = log.measurements.slice(-500);
          await brain.supabaseAdmin
            .from("user_preferences")
            .upsert(
              { user_id: userId || "system", key: logKey, value: log },
              { onConflict: "user_id,key" },
            );
          return {
            status: "recorded",
        ...
        if (
          toolInput.action === "history" ||
          toolInput.action === "trend" ||
          toolInput.action === "report"
        ) {
          const { data } = await brain.supabaseAdmin
            .from("user_preferences")
            .select("value")
            ...
            .maybeSingle();
          if (!data?.value)
            return { error: "No measurements found for this equipment" };
          ...
          return {
            ...
            pass_rate:
              filtered.length > 0
                ? (
                    (filtered.filter((m) => m.status === "PASS").length /
                      filtered.filter((m) => m.status).length) *
                    100
                  ).toFixed(1) + "%"
                : "N/A",
          };
      ...
      case "manage_calendar": {
        ...
        if (toolInput.action === "create") {
          ...
          await brain.supabaseAdmin
            .from("user_preferences")
            .upsert(
              { user_id: userId || "system", key: calKey, value: calendar },
              { onConflict: "user_id,key" },
            );
        ...
        if (
          ...
          toolInput.action === "today" ||
          toolInput.action === "week"
        ) {
          const now = new Date();
          const today = now.toISOString().split("T")[0];
          let filtered = calendar.events;
          if (toolInput.action === "today")
      ...
      case "create_document": {
        ...
        await brain.supabaseAdmin
          .from("user_preferences")
          .upsert(
            { user_id: userId || "system", key: docKey, value: doc },
            { onConflict: "user_id,key" },
          );
        return {
          status: "created",
          ...
          title: toolInput.title,
          message:
            "Document generated and saved. Tell me if you want to modify or export it.",
        };
      }
      case "task_manager": {
        if (!brain.supabaseAdmin) return { error: "Database not connected" };
        ...
        if (toolInput.action === "add") {
          ...
          await brain.supabaseAdmin
            .from("user_preferences")
            .upsert(
              { user_id: userId || "system", key: taskKey, value: tasks },
              { onConflict: "user_id,key" },
            );
          return { status: "added", item, total: tasks.items.length };
        }
        if (toolInput.action === "complete") {
          const found = tasks.items.find((t) =>
            t.task.toLowerCase().includes((toolInput.task || "").toLowerCase()),
          );
          if (found) {
            found.status = "done";
        ...
        if (
          ...
          if (toolInput.project)
            filtered = filtered.filter((t) => t.project === toolInput.project);
          if (toolInput.status)
            filtered = filtered.filter((t) => t.status === toolInput.status);
          return {
            tasks: filtered,
      ...
      case "contact_book": {
        ...
        if (toolInput.action === "add") {
          ...
          await brain.supabaseAdmin
            .from("user_preferences")
            .upsert(
              { user_id: userId || "system", key: cbKey, value: contacts },
              { onConflict: "user_id,key" },
            );
        ...
        if (toolInput.action === "list") {
          ...
          if (toolInput.category)
            filtered = filtered.filter(
              (c) => c.category === toolInput.category,
            );
      ...
      case "draw_diagram": {
        ...
        if (
          toolInput.action === "analyze" &&
          brain._currentMediaData?.imageBase64
        ) {
          return await brain._vision(
            brain._currentMediaData.imageBase64,
            userId,
          );
        }
      ...
      case "create_spreadsheet": {
        ...
        const spreadsheet = {
          ...
          columns: toolInput.columns
            ? toolInput.columns.split(",").map((c) => c.trim())
            : [],
          data: toolInput.data,
        ...
        await brain.supabaseAdmin
          .from("user_preferences")
          .upsert(
            { user_id: userId || "system", key: ssKey, value: spreadsheet },
            { onConflict: "user_id,key" },
          );
        return {
          status: "created",
      ...
      case "create_presentation": {
        ...
        await brain.supabaseAdmin
          .from("user_preferences")
          .upsert(
            { user_id: userId || "system", key: presKey, value: presentation },
            { onConflict: "user_id,key" },
          );
        return {
          status: "created",
      ...
      case "pcb_inspection": {
        if (!brain._currentMediaData?.imageBase64)
          return {
            error:
              "No PCB image uploaded. Please take a photo or upload an image of the PCB.",
          };
      ...
      case "thermal_analysis": {
        if (!brain._currentMediaData?.imageBase64)
          return {
            error:
              "No thermal image uploaded. Please upload a thermal camera image.",
          };
      ...
      case "microscope_analysis": {
        if (!brain._currentMediaData?.imageBase64)
          return {
            error:
              "No microscope image uploaded. Please upload a microscope capture.",
          };
      ...
      case "visual_quality_check": {
        if (!brain._currentMediaData?.imageBase64)
          return {
            error:
              "No product image uploaded. Please upload a photo for quality inspection.",
          };
      ...
      case "compare_images": {
        if (!brain._currentMediaData?.imageBase64)
          return {
            error:
              "Please upload the image(s) to compare. For before/after, upload the current state.",
          };
      ...
      case "grade_book": {
        ...
        if (toolInput.action === "add_grade") {
          ...
          if (!gradebook.students[key])
            gradebook.students[key] = { grades: [], absences: 0 };
          ...
          await brain.supabaseAdmin
            .from("user_preferences")
            .upsert(
              { user_id: userId || "system", key: gbKey, value: gradebook },
              { onConflict: "user_id,key" },
            );
          return {
            status: "recorded",
      ...
      case "legal_consultant": {
        ...
        return {
          ...
          disclaimer:
            "⚠️ Informativ — nu constituie consiliere juridică. Consultați un avocat.",
        };
      }
      // ═══ FINANCE ═══
      ...
      case "marketing_analyzer": {
        if (
          toolInput.action === "keywords" ||
          toolInput.action === "seo_audit" ||
          toolInput.action === "competitor"
        ) {
          return await brain._search(
        ...
        if (
          ...
          try {
            ...
            if (toolInput.action === "bmi") {
              const bmi =
                (p.weight_kg || 75) / Math.pow((p.height_cm || 175) / 100, 2);
              return {
                bmi: bmi.toFixed(1),
                category:
                  bmi < 18.5
      ...
      case "agro_advisor": {
        if (
          toolInput.action === "pest_identify" &&
          brain._currentMediaData?.imageBase64
        ) {
          return await brain._vision(
            brain._currentMediaData.imageBase64,
