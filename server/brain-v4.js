  ...
  // ═══ PROGRAMMING TOOLS ═══
  {
    ...
    input_schema: {
      ...
      properties: {
        code: {
          type: 'string',
          description: 'JavaScript code to execute. Must return a value or use /* /* /* /* /* /* /* /* /* /* /* /* /* /* /* /* /* console.log() (removed) */ (removed) */ (removed) */ (removed) */ (removed) */ (removed) */ (removed) */ (removed) */ (removed) */ (removed) */ (removed) */ (removed) */ (removed) */ (removed) */ (removed) */ (removed) */ (removed) */.',
        },
      },
      required: ['code'],
    },
