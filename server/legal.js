...
router.get('/privacy', (req, res) => {
  res.json({
    ...
    sections: [
      ...
      {
        title: '8. Cookies',
        content: 'We use only essential cookies for authentication. Zero tracking or advertising cookies.',
      },
    ],
  });
});
...
router.delete('/gdpr/delete', async (req, res) => {
  try {
    ...
    try {
      ...
      logger.warn({ component: 'Legal', err: e.message }, 'subscription might not exist');
    }
