...
// ── OpenAI Realtime / TTS voices (override with env vars) ──
// Available: alloy, echo, fable, onyx, nova, shimmer, ash, ballad, coral, sage, verse
const OPENAI_AVATAR_VOICES = {
  kelion: process.env.OPENAI_VOICE_KELION || 'echo',    // Deep, warm, masculine
  kira:   process.env.OPENAI_VOICE_KIRA   || 'shimmer', // Warm, natural, feminine
};

module.exports = {
  OPENAI_AVATAR_VOICES, VOICES, LEGACY_VOICES, getVoiceId };
