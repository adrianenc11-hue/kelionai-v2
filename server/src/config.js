...
module.exports = {
  ...
  google: {
    ...
    chatModel:    optional('GOOGLE_CHAT_MODEL', 'google/gemma-2-27b-it'),
    liveModel:    optional('OPENROUTER_MODEL', 'google/gemma-2-27b-it'),
    ttsModel:     optional('GOOGLE_TTS_MODEL', 'google/gemma-2-27b-it'),
