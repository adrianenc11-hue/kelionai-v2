...
// ── Forex pair metadata ──
const PAIRS = {
    EUR_USD: { pipSize: 0.0001, pipValue: 10, avgSpread: 0.00012, baseCcy: "EUR", quoteCcy: "USD" },
    GBP_USD: { pipSize: 0.0001, pipValue: 10, avgSpread: 0.00015, baseCcy: "GBP", quoteCcy: "USD" },
    USD_JPY: { pipSize: 0.01, pipValue: 6.7, avgSpread: 0.012, baseCcy: "USD", quoteCcy: "JPY" },
    GBP_JPY: { pipSize: 0.01, pipValue: 6.7, avgSpread: 0.025, baseCcy: "GBP", quoteCcy: "JPY" },
    EUR_GBP: { pipSize: 0.0001, pipValue: 12.5, avgSpread: 0.00015, baseCcy: "EUR", quoteCcy: "GBP" },
    AUD_USD: { pipSize: 0.0001, pipValue: 10, avgSpread: 0.00015, baseCcy: "AUD", quoteCcy: "USD" },
    USD_CHF: { pipSize: 0.0001, pipValue: 10, avgSpread: 0.00015, baseCcy: "USD", quoteCcy: "CHF" },
    USD_CAD: { pipSize: 0.0001, pipValue: 7.5, avgSpread: 0.00018, baseCcy: "USD", quoteCcy: "CAD" },
    NZD_USD: { pipSize: 0.0001, pipValue: 10, avgSpread: 0.00018, baseCcy: "NZD", quoteCcy: "USD" },
    EUR_JPY: { pipSize: 0.01, pipValue: 6.7, avgSpread: 0.02, baseCcy: "EUR", quoteCcy: "JPY" },
};
...
const SESSIONS = {
    ...
    newYork: { open: 13, close: 22, name: "New York", emoji: "🇺🇸", quality: "high" },
...
class ForexEngine {
    constructor() {
        ...
        this.oandaHost = (process.env.OANDA_ENV || "practice") === "live"
    ...
    async placeOrder(pair, units, type = "MARKET", slPrice = null, tpPrice = null) {
        if (!this.oandaKey || !this.oandaAcct) {
            return { success: false, error: "OANDA not configured (set OANDA_API_KEY + OANDA_ACCOUNT_ID)" };
        }
