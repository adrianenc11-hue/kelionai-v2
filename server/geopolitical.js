...
async function fetchFredData() {
  ...
  if (!apiKey) {
    result.note =
      "Set FRED_API_KEY for real-time macro data. Get free key at https://fred.stlouisfed.org/docs/api/api_key.html";
      ...
      if (res.ok) {
        ...
        if (obs.length > 0) {
          result.indicators[id] = {
            ...
            trend:
              obs.length > 1
                ? parseFloat(obs[0].value) > parseFloat(obs[1].value)
                  ? "rising"
                  : "falling"
                : "unknown",
          };
...
function classifyEvent(title) {
  ...
  if (/war|military|attack|bomb|missile|invasion|troops/.test(lower))
    return "MILITARY";
  if (/sanction|embargo|trade war|tariff/.test(lower)) return "SANCTIONS";
  if (/election|vote|referendum|parliament|congress/.test(lower))
    return "POLITICAL";
  if (/protest|riot|revolution|coup|uprising/.test(lower))
    return "CIVIL_UNREST";
  if (/central bank|fed|ecb|boj|interest rate|rate hike|rate cut/.test(lower))
...
async function calculateGeopoliticalRisk() {
  ...
  if (militaryEvents > 0) {
    factors.push({
      ...
      score: geoPoints,
      detail: `${militaryEvents} high-impact events in 24h`,
    });
  }
  ...
  if (fearGreed.current) {
    ...
    const fgRisk =
      fg <= 20 ? 25 : fg >= 80 ? 20 : fg <= 35 ? 15 : fg >= 65 ? 10 : 0;
    riskScore += fgRisk;
    factors.push({
      factor: "Fear & Greed",
      score: fgRisk,
      detail: `${fg} (${fearGreed.current.label})`,
    });
  }
  ...
  const result = {
    ...
    sources: {
      ...
      fred: fred.hasApiKey
        ? Object.keys(fred.indicators).length + " indicators"
        : "No API key",
    },
...
const HISTORICAL_EVENTS = [
  // 2001-2005
  {
    ...
    severity: 100,
    event: "9/11 Attacks",
    impact: "S&P -11.6% in 1 week, markets closed 4 days",
    assets: ["S&P 500", "NASDAQ", "Gold", "Oil"],
  },
  {
    date: "2001-10-07",
    category: "MILITARY",
    severity: 70,
    event: "US invasion of Afghanistan",
    impact: "Oil +5%, defense stocks surge",
    assets: ["Oil", "S&P 500"],
  },
  {
    date: "2003-03-20",
    ...
    impact: "Oil +33% in 3 months, S&P rallied after uncertainty cleared",
    assets: ["Oil", "S&P 500", "Gold"],
  },
  ...
  // 2007-2009 Financial Crisis
  {
    ...
    category: "ECONOMIC",
    severity: 85,
    event: "BNP Paribas freezes funds — subprime crisis begins",
    impact: "Credit markets freeze, VIX spikes",
    assets: ["S&P 500", "NASDAQ"],
  },
  {
    date: "2008-03-16",
    category: "ECONOMIC",
    severity: 90,
    event: "Bear Stearns collapse",
    impact: "S&P -5% in 1 day",
    assets: ["S&P 500", "NASDAQ"],
  },
  {
    date: "2008-09-15",
    category: "ECONOMIC",
    severity: 100,
    event: "Lehman Brothers bankruptcy — Global Financial Crisis",
    impact: "S&P -57% peak-to-trough, Gold +25%",
    assets: ["S&P 500", "NASDAQ", "Gold", "EUR/USD"],
  },
  {
    date: "2008-10-03",
    category: "MONETARY_POLICY",
    severity: 80,
    event: "TARP bailout $700B signed",
    impact: "Markets stabilize temporarily",
    assets: ["S&P 500", "NASDAQ"],
  },
  {
    date: "2009-03-09",
    category: "ECONOMIC",
    severity: 95,
    event: "S&P 500 hits 666 — market bottom",
    impact: "Begin of 11-year bull run",
    assets: ["S&P 500", "NASDAQ"],
  },
  ...
  // 2010-2012 European Debt Crisis
  {
    ...
    category: "ECONOMIC",
    severity: 75,
    event: "Greece bailout €110B",
    impact: "EUR/USD -15% in 6 months",
    assets: ["EUR/USD", "S&P 500"],
  },
  {
    date: "2010-05-06",
    category: "ECONOMIC",
    severity: 60,
    event: "Flash Crash — Dow drops 1000 points in minutes",
    impact: "S&P -9.2% intraday",
    assets: ["S&P 500", "NASDAQ"],
  },
  {
    date: "2011-08-05",
    category: "ECONOMIC",
    severity: 70,
    event: "US credit rating downgraded by S&P",
    impact: "S&P -6.7% in 1 day, Gold +3.5%",
    assets: ["S&P 500", "Gold"],
  },
  {
    date: "2012-07-26",
    category: "MONETARY_POLICY",
    severity: 65,
    event: "Draghi: 'Whatever it takes' to save Euro",
    impact: "EUR rallies, European markets recover",
    assets: ["EUR/USD"],
  },
  ...
  // 2013-2015
  {
    ...
    category: "MONETARY_POLICY",
    severity: 55,
    event: "Fed Taper Tantrum — Bernanke hints QE reduction",
    impact: "Bond yields spike, EM currencies crash",
    assets: ["S&P 500", "Gold"],
  },
  {
    date: "2014-03-18",
    ...
    impact: "Russian Ruble -50%, Oil starts decline, Gold +5%",
    assets: ["Oil", "Gold", "EUR/USD"],
  },
  {
    date: "2014-06-20",
    category: "ENERGY",
    severity: 70,
    event: "Oil crash begins — $107 to $26",
    impact: "Oil -75% over 18 months",
    assets: ["Oil"],
  },
  {
    date: "2015-08-11",
    category: "ECONOMIC",
    severity: 65,
    event: "China devalues Yuan — Black Monday Aug 24",
    impact: "S&P -11% in 6 days, global selloff",
    assets: ["S&P 500", "NASDAQ"],
  },
  ...
  // 2016-2017
  {
    ...
    category: "POLITICAL",
    severity: 75,
    event: "Brexit vote — UK leaves EU",
    impact: "GBP/USD -11% overnight, FTSE -3%",
    assets: ["GBP/USD", "EUR/USD", "S&P 500"],
  },
  {
    date: "2016-11-08",
    category: "POLITICAL",
    severity: 60,
    event: "Trump elected US President",
    impact: "Futures -5% overnight, then V-recovery. S&P +5% in 1 month",
    assets: ["S&P 500", "NASDAQ", "Gold"],
  },
  {
    date: "2017-12-17",
    category: "ECONOMIC",
    severity: 50,
    event: "Bitcoin hits $19,783 — first crypto bubble peak",
    impact: "BTC -84% over next year",
    assets: ["BTC"],
  },
  ...
  // 2018-2019
  {
    ...
    category: "ECONOMIC",
    severity: 55,
    event: "Volmageddon — VIX spike from 13 to 50",
    impact: "S&P -10% in 2 weeks, XIV ETN wiped out",
    assets: ["S&P 500", "NASDAQ"],
  },
  {
    date: "2018-03-22",
    category: "SANCTIONS",
    severity: 60,
    event: "US-China trade war begins — tariffs announced",
    impact: "S&P -20% by Dec 2018",
    assets: ["S&P 500", "NASDAQ"],
  },
  {
    date: "2019-08-05",
    category: "SANCTIONS",
    severity: 50,
    event: "US labels China currency manipulator",
    impact: "S&P -3% in 1 day, Gold spikes",
    assets: ["S&P 500", "Gold"],
  },
  ...
  // 2020 COVID
  {
    ...
    severity: 60,
    event: "WHO declares COVID global emergency",
    impact: "Initial market uncertainty",
    assets: ["S&P 500", "Oil", "Gold"],
  },
  {
    date: "2020-03-09",
    category: "HEALTH_CRISIS",
    severity: 95,
    event: "COVID crash + Oil price war — Black Monday",
    impact: "S&P -12% in 1 day, Oil -26%",
    assets: ["S&P 500", "NASDAQ", "Oil", "BTC"],
  },
  {
    date: "2020-03-16",
    category: "HEALTH_CRISIS",
    severity: 100,
    event: "COVID lockdowns worldwide — worst since 1929",
    impact: "S&P -34% from peak, circuit breakers triggered 4x",
    assets: ["S&P 500", "NASDAQ", "Oil", "BTC", "Gold"],
  },
  {
    date: "2020-03-23",
    category: "MONETARY_POLICY",
    severity: 85,
    event: "Fed unlimited QE + $2.2T CARES Act",
    impact: "Market bottom, begin fastest recovery in history",
    assets: ["S&P 500", "NASDAQ", "BTC", "Gold"],
  },
  {
    date: "2020-04-20",
    category: "ENERGY",
    severity: 90,
    event: "Oil goes NEGATIVE — WTI at -$37",
    impact: "First negative oil price in history",
    assets: ["Oil"],
  },
  ...
  // 2021
  {
    ...
    category: "ECONOMIC",
    severity: 45,
    event: "GameStop short squeeze — retail vs Wall St",
    impact: "VIX +60%, broader market -3%",
    assets: ["S&P 500", "NASDAQ"],
  },
  {
    date: "2021-05-19",
    category: "SANCTIONS",
    severity: 55,
    event: "China bans crypto mining + trading",
    impact: "BTC -53% from peak ($64K to $30K)",
    assets: ["BTC", "ETH", "SOL"],
  },
  {
    date: "2021-11-10",
    category: "ECONOMIC",
    severity: 50,
    event: "BTC hits ATH $69,000 + ETH $4,867",
    impact: "Begin of crypto winter",
    assets: ["BTC", "ETH", "SOL"],
  },
  ...
  // 2022
  {
    ...
    impact: "Oil +30%, Gold +8%, S&P -5%, Gas +300% in EU",
    assets: ["Oil", "Gold", "S&P 500", "EUR/USD", "BTC"],
  },
  {
    date: "2022-03-16",
    category: "MONETARY_POLICY",
    severity: 75,
    event: "Fed begins rate hikes — 0.25% to fight inflation",
    impact: "S&P -25% over 9 months, BTC -65%",
    assets: ["S&P 500", "NASDAQ", "BTC", "Gold"],
  },
  {
    date: "2022-05-09",
    category: "ECONOMIC",
    severity: 80,
    event: "Terra/LUNA collapse — $40B wiped",
    impact: "BTC -30%, entire crypto market crash",
    assets: ["BTC", "ETH", "SOL"],
  },
  {
    date: "2022-06-13",
    category: "ECONOMIC",
    severity: 70,
    event: "Celsius/3AC/Voyager crypto bankruptcies",
    impact: "BTC hits $17,600, crypto contagion",
    assets: ["BTC", "ETH", "SOL"],
  },
  {
    date: "2022-09-26",
    category: "MILITARY",
    severity: 65,
    event: "Nord Stream pipelines sabotaged",
    impact: "EU gas prices spike, EUR/USD hits 20-year low",
    assets: ["Oil", "EUR/USD"],
  },
  {
    date: "2022-11-08",
    category: "ECONOMIC",
    severity: 85,
    event: "FTX collapse — $32B exchange bankrupt",
    impact: "BTC -25%, SOL -60%, crypto trust crisis",
    assets: ["BTC", "ETH", "SOL"],
  },
  ...
  // 2023
  {
    ...
    category: "ECONOMIC",
    severity: 70,
    event: "Silicon Valley Bank collapses",
    impact: "Bank stocks -20%, BTC +30% (flight from banks)",
    assets: ["S&P 500", "BTC", "Gold"],
  },
  {
    date: "2023-10-07",
    category: "MILITARY",
    severity: 80,
    event: "Hamas attacks Israel — Middle East war",
    impact: "Oil +6%, Gold +3%, risk-off sentiment",
    assets: ["Oil", "Gold", "S&P 500"],
  },
  ...
  // 2024
  {
    ...
    category: "ECONOMIC",
    severity: 50,
    event: "Bitcoin ETF approved by SEC",
    impact: "BTC +60% in 2 months, institutional inflows",
    assets: ["BTC", "ETH"],
  },
  {
    date: "2024-03-11",
    category: "ECONOMIC",
    severity: 40,
    event: "BTC hits new ATH $73,000",
    impact: "Crypto bull market confirmed",
    assets: ["BTC", "ETH", "SOL"],
  },
  {
    date: "2024-08-05",
    category: "ECONOMIC",
    severity: 65,
    event: "Japan carry trade unwind — global selloff",
    impact: "Nikkei -12%, S&P -3%, BTC -15%",
    assets: ["S&P 500", "BTC", "NASDAQ"],
  },
  ...
  // 2025
  {
    ...
    category: "POLITICAL",
    severity: 45,
    event: "Trump inauguration — tariff threats",
    impact: "Market uncertainty, USD strengthens",
    assets: ["S&P 500", "EUR/USD", "BTC"],
  },
  {
    date: "2025-02-01",
    category: "SANCTIONS",
    severity: 60,
    event: "US tariffs on China, Canada, Mexico",
    impact: "S&P -2%, supply chain fears",
    assets: ["S&P 500", "NASDAQ"],
  },
];
...
function getHistoricalRiskContext(currentCategory) {
  const similar = HISTORICAL_EVENTS.filter(
  ...
  return {
    ...
    recentSimilar: similar.filter(
      (e) => new Date(e.date) > new Date("2022-01-01"),
    ),
...
async function brainScan() {
  ...
  risk.factors.forEach((f) => {
    const category = f.factor.includes("Geopolitical")
      ? "MILITARY"
      : f.factor.includes("Fear")
        ? "ECONOMIC"
        : f.factor.includes("Yield")
          ? "MONETARY_POLICY"
          : f.factor.includes("VIX")
            ? "ECONOMIC"
            : "OTHER";
