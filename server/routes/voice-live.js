...
// Masculin: echo (deep, warm), ash (clear), ballad (rich)
// Feminin: shimmer (warm, natural), nova (bright), coral (expressive), sage (calm)
...
${userName ? `The user's name is ${userName}. Use their first name naturally.` : ''}`,
          ...
          input_audio_transcription: { model: MODELS.OPENAI_WHISPER || 'whisper-1' },
          turn_detection: {
            type: 'server_vad',
            threshold: 0.45,
