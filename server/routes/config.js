...
function buildClientUrls() {
  return {
    ...
    // ── Hărți ──
    GOOGLE_MAPS:   process.env.GOOGLE_MAPS_FULL_ENDPOINT || '',
    OSM_EMBED:     process.env.OSM_EXPORT_ENDPOINT       || '',

    // ── Media Embeds ──
    YOUTUBE_EMBED: process.env.YOUTUBE_EMBED_URL         || '',
    SPOTIFY_EMBED: process.env.SPOTIFY_EMBED_URL         || '',

    // ── Servicii externe ──
    DICEBEAR:      process.env.DICEBEAR_URL              || '',

    // ── Fonturi Google ──
    GOOGLE_FONTS_CSS:           process.env.GOOGLE_FONTS_CSS           || '',
    GOOGLE_FONTS_STATIC:        process.env.GOOGLE_FONTS_STATIC        || '',
    GOOGLE_FONTS_INTER:         process.env.GOOGLE_FONTS_INTER         || '',
    GOOGLE_FONTS_INTER_LIGHT:   process.env.GOOGLE_FONTS_INTER_LIGHT   || '',
    GOOGLE_FONTS_INTER_BASIC:   process.env.GOOGLE_FONTS_INTER_BASIC   || '',
    GOOGLE_FONTS_INTER_JETBRAINS: process.env.GOOGLE_FONTS_INTER_JETBRAINS || '',

    // ── CDN Libraries ──
    CDN_TENSORFLOW:  process.env.CDN_TENSORFLOW  || '',
    CDN_COCOSSD:     process.env.CDN_COCOSSD     || '',
    CDN_SENTRY_JS:   process.env.CDN_SENTRY_JS   || '',
    CDN_LOGROCKET:   process.env.CDN_LOGROCKET   || '',
    CDN_LEAFLET_CSS: process.env.CDN_LEAFLET_CSS || '',
    CDN_LEAFLET_JS:  process.env.CDN_LEAFLET_JS  || '',
    CARTO_TILES:     process.env.CARTO_TILES     || '',
    CARTO_TILE_LAYER: process.env.CARTO_TILE_LAYER || '',
    OLLAMA_SITE:     process.env.OLLAMA_SITE     || '',
    SVG_NAMESPACE:   process.env.SVG_NAMESPACE   || '',
