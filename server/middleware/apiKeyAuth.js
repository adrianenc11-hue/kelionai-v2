      ...
      supabaseAdmin
        ...
        .catch((rpcErr) => {
          ...
          supabaseAdmin
            ...
            .eq('id', data.id)
            .then(() => {})
            .catch((e) => logger.warn({ component: 'ApiKeyAuth', err: e.message }, 'Fallback update failed'));
        });

      next();
    })
    .catch((e) => {
      logger.error({ component: 'ApiKeyAuth', err: e.message }, 'API key validation query failed');
