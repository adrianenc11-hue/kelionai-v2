...
const BASE = process.env.BASE_URL || process.env.API_BASE_URL || 'https://kelionai.app';

const PROBES = [
    { path: '/health', expectStatus: 200, expectJson: true, checkField: 'status' },
    { path: '/api/payments/plans', expectStatus: 200, expectJson: true, checkField: 'plans' },
