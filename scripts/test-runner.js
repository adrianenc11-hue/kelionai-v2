...
setTimeout(async () => {
    ...
    await testEndpoint('WhatsApp Send', 'POST', '/api/whatsapp/send', { to: '123', text: 'hi' });
    await testEndpoint('Media Publish', 'POST', '/api/media/publish', { platform: 'all', content: 'test' });
