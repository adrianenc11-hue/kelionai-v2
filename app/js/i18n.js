...
(function () {
  ...
  var translations = {
    en: {
      ...
      "onboarding.subtitle":
        "Your personal AI assistant — smart, fast, multilingual.",
      ...
      "monitor.default.text":
        "The monitor will display content when the AI assistant shares information.",
      ...
      "error.description":
        "The server encountered a problem. The team has been notified.",
      "error.retry": "Try Again",
      "error.report": "Report Issue",
      // ─── Pricing page ─────────────────────────────────────────
      "pricing.hero.title": "Choose the right plan for you",
      "pricing.hero.subtitle":
        "Access the most advanced AI assistant with 3D avatar",
      ...
      "pricing.faq.payment.a":
        "We accept all credit/debit cards (Visa, Mastercard, Amex) through Stripe.",
      ...
      "settings.notif.browser.desc":
        "Receive an alert when the AI finishes responding",
      "settings.notif.sounds.label": "UI sounds",
      "settings.notif.sounds.desc":
        "Sounds when sending and receiving messages",
    ...
    ro: {
      ...
      "onboarding.subtitle":
        "Asistentul tău AI personal — inteligent, rapid, multilingv.",
      ...
      "monitor.default.text":
        "Monitorul va afișa conținut când asistentul AI partajează informații.",
      ...
      "error.description":
        "Serverul a întâmpinat o problemă. Echipa a fost notificată.",
      "error.retry": "Reîncearcă",
      "error.report": "Raportează problema",
      "pricing.hero.title": "Alege planul potrivit pentru tine",
      "pricing.hero.subtitle":
        "Acces la cel mai avansat asistent AI cu avatar 3D",
      ...
      "pricing.faq.cancel.a":
        "Da, poți anula abonamentul oricând din pagina de billing. Nu există penalizări.",
      "pricing.faq.payment.q": "Ce metode de plată acceptați?",
      "pricing.faq.payment.a":
        "Acceptăm toate cardurile de credit/debit (Visa, Mastercard, Amex) prin Stripe.",
      ...
      "settings.notif.browser.desc":
        "Primește alertă când AI termină de răspuns",
      "settings.notif.sounds.label": "Sunete UI",
      "settings.notif.sounds.desc":
        "Sunete la trimiterea și primirea mesajelor",
    ...
    fr: {
      ...
      "onboarding.subtitle":
        "Votre assistant IA personnel — intelligent, rapide, multilingue.",
      ...
      "onboarding.plan.free.price": "Gratuit",
      "onboarding.plan.pro.name": "Pro",
      "onboarding.plan.pro.desc":
        "200 messages/jour · Toutes les fonctionnalités",
      ...
      "monitor.default.text":
        "Le moniteur affichera du contenu lorsque l'assistant IA partagera des informations.",
      "monitor.default.hint":
        'Dites "qu\'est-ce qu\'il y a devant" ou "montrez-moi une carte"',
      ...
      "error.description":
        "Le serveur a rencontré un problème. L'équipe a été notifiée.",
      "error.retry": "Réessayer",
      "error.report": "Signaler le problème",
      "pricing.hero.title": "Choisissez le plan qui vous convient",
      "pricing.hero.subtitle":
        "Accédez à l'assistant IA le plus avancé avec avatar 3D",
      ...
      "pricing.faq.payment.a":
        "Nous acceptons toutes les cartes de crédit/débit (Visa, Mastercard, Amex) via Stripe.",
      ...
      "settings.lang.desc":
        "La langue dans laquelle vous recevez les réponses IA",
      ...
      "settings.notif.browser.desc":
        "Recevez une alerte quand l'IA a terminé de répondre",
      "settings.notif.sounds.label": "Sons UI",
      "settings.notif.sounds.desc":
        "Sons lors de l'envoi et de la réception des messages",
      "settings.notif.ticker.label": "Fil d'actualités",
      "settings.notif.ticker.desc":
        "Afficher les actualités en direct dans la barre inférieure",
    ...
    de: {
      ...
      "onboarding.subtitle":
        "Ihr persönlicher KI-Assistent — intelligent, schnell, mehrsprachig.",
      ...
      "monitor.default.text":
        "Der Monitor zeigt Inhalte an, wenn der KI-Assistent Informationen teilt.",
      "monitor.default.hint":
        'Sagen Sie "was ist vorne" oder "zeig mir eine Karte"',
      "monitor.title": "Monitor",
      ...
      "error.description":
        "Der Server ist auf ein Problem gestoßen. Das Team wurde benachrichtigt.",
      "error.retry": "Erneut versuchen",
      "error.report": "Problem melden",
      "pricing.hero.title": "Wählen Sie den richtigen Plan für Sie",
      "pricing.hero.subtitle":
        "Zugang zum fortschrittlichsten KI-Assistenten mit 3D-Avatar",
      ...
      "pricing.faq.payment.a":
        "Wir akzeptieren alle Kredit-/Debitkarten (Visa, Mastercard, Amex) über Stripe.",
      ...
      "settings.notif.browser.desc":
        "Erhalten Sie eine Benachrichtigung, wenn die KI fertig ist",
      "settings.notif.sounds.label": "UI-Töne",
      "settings.notif.sounds.desc":
        "Töne beim Senden und Empfangen von Nachrichten",
      "settings.notif.ticker.label": "Nachrichten-Ticker",
      "settings.notif.ticker.desc":
        "Live-Nachrichten in der unteren Leiste anzeigen",
    ...
    es: {
      ...
      "onboarding.subtitle":
        "Tu asistente IA personal — inteligente, rápido, multilingüe.",
      ...
      "monitor.default.text":
        "El monitor mostrará contenido cuando el asistente IA comparta información.",
      ...
      "error.description":
        "El servidor encontró un problema. El equipo ha sido notificado.",
      "error.retry": "Reintentar",
      "error.report": "Reportar problema",
      "pricing.hero.title": "Elige el plan adecuado para ti",
      "pricing.hero.subtitle":
        "Accede al asistente IA más avanzado con avatar 3D",
      ...
      "settings.notif.browser.desc":
        "Recibe una alerta cuando la IA termine de responder",
      ...
      "settings.notif.ticker.desc":
        "Mostrar noticias en vivo en la barra inferior",
    ...
    it: {
      ...
      "onboarding.subtitle":
        "Il tuo assistente IA personale — intelligente, veloce, multilingue.",
      ...
      "monitor.default.text":
        "Il monitor mostrerà contenuto quando l'assistente IA condividerà informazioni.",
      ...
      "error.description":
        "Il server ha riscontrato un problema. Il team è stato notificato.",
      "error.retry": "Riprova",
      "error.report": "Segnala il problema",
      "pricing.hero.title": "Scegli il piano giusto per te",
      "pricing.hero.subtitle":
        "Accedi all'assistente IA più avanzato con avatar 3D",
      ...
      "pricing.faq.payment.a":
        "Accettiamo tutte le carte di credito/debito (Visa, Mastercard, Amex) tramite Stripe.",
      ...
      "settings.notif.browser.desc":
        "Ricevi un avviso quando l'IA finisce di rispondere",
      "settings.notif.sounds.label": "Suoni UI",
      "settings.notif.sounds.desc":
        "Suoni all'invio e alla ricezione dei messaggi",
      "settings.notif.ticker.label": "Ticker di notizie",
      "settings.notif.ticker.desc":
        "Mostra notizie in tempo reale nella barra inferiore",
  ...
  var LANG_PATTERNS = [
    ...
    {
      lang: "fr",
      re: /\b(je|il|elle|nous|vous|ils|elles|avec|dans|sur|par|les|des|une|bonjour|merci|oui|non|comment|pourquoi|quoi|qui|où|quand|très|mais|donc|ni|car|cet|cette|mon|ton|son|ma|ta)\b/i,
    },
    {
      lang: "de",
      re: /\b(ich|du|er|sie|wir|ihr|ist|sind|mit|für|auf|bei|aus|nach|von|über|unter|an|in|zu|ein|eine|der|die|das|und|oder|aber|nicht|ja|nein|hallo|danke|bitte|wie|was|wer|wo|wann|warum|auch|noch|schon)\b/i,
    },
    {
      lang: "es",
      re: /\b(yo|tú|él|ella|nosotros|vosotros|ellos|es|son|con|para|en|por|de|del|hola|gracias|sí|no|cómo|qué|quién|dónde|cuándo|muy|pero|también|ya|más|menos|bueno|malo|grande|pequeño)\b/i,
    },
    {
      lang: "it",
      re: /\b(io|tu|lui|lei|noi|voi|loro|è|sono|con|per|in|su|da|di|un|una|ciao|grazie|sì|no|come|perché|cosa|chi|dove|quando|molto|ma|anche|già|più|meno|buono|cattivo|grande|piccolo)\b/i,
    },
    {
      lang: "pt",
      re: /\b(eu|tu|ele|ela|nós|vós|eles|elas|é|são|com|para|em|por|de|do|da|um|uma|olá|obrigado|sim|não|como|por que|quê|quem|onde|quando|muito|mas|também|já|mais|menos|bom|mau)\b/i,
    },
    {
      lang: "nl",
      re: /\b(ik|jij|hij|zij|wij|jullie|zij|is|zijn|met|voor|in|op|bij|uit|aan|van|het|de|een|hallo|dank|ja|nee|hoe|waarom|wat|wie|waar|wanneer|ook|al|meer|minder|goed|slecht)\b/i,
    },
    {
      lang: "pl",
      re: /\b(ja|ty|on|ona|my|wy|oni|jest|są|z|dla|w|na|po|od|do|ten|ta|to|cześć|dziękuję|tak|nie|jak|dlaczego|co|kto|gdzie|kiedy|bardzo|ale|też|już|więcej|mniej|dobry|zły)\b/i,
    },
    {
      lang: "ru",
      re: /\b(я|ты|он|она|мы|вы|они|есть|быть|с|для|в|на|по|от|к|привет|спасибо|да|нет|как|почему|что|кто|где|когда|очень|но|тоже|уже|больше|меньше|хороший|плохой)\b/i,
    },
    {
      lang: "uk",
      re: /\b(я|ти|він|вона|ми|ви|вони|є|бути|з|для|в|на|по|від|до|привіт|дякую|так|ні|як|чому|що|хто|де|коли|дуже|але|також|вже|більше|менше|добрий|поганий)\b/i,
    },
    {
      lang: "tr",
      re: /\b(ben|sen|o|biz|siz|onlar|bu|bir|için|ile|de|da|ve|ama|çok|ne|kim|nerede|nasıl|merhaba|teşekkür|evet|hayır|var|yok|iyi|kötü|büyük|küçük)\b/i,
    },
    { lang: "ar", re: /[\u0600-\u06FF]/ },
    { lang: "he", re: /[\u0590-\u05FF]/ },
    { lang: "ja", re: /[\u3040-\u309F\u30A0-\u30FF]/ },
    ...
    {
      lang: "en",
      re: /\b(the|is|are|was|were|with|for|and|or|but|in|on|at|to|of|a|an|hello|hi|thanks|thank|yes|no|how|why|what|who|where|when|very|also|already|more|less|good|bad|big|small)\b/i,
    },
  ];
  ...
  try {
    ...
    var hasToken =
      sessionStorage.getItem("kelion_token") ||
  ...
  function setLanguage(lang) {
    ...
    if (window.KVoice && typeof KVoice.setLanguage === "function")
      KVoice.setLanguage(lang);
    // Dispatch event so other modules can react
    window.dispatchEvent(
      new CustomEvent("kelion-lang-changed", { detail: { lang: lang } }),
    );
  }
