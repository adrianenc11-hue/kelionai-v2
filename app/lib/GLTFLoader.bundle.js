var THREE_ADDONS = (() => {
  ...
  var GLTFParser = class {
    ...
    loadMaterial(materialIndex) {
      ...
      if (materialDef.emissiveTexture !== void 0 && materialType !== import_three2.MeshBasicMaterial) {
        pending.push(
          parser.assignTexture(materialParams, 'emissiveMap', materialDef.emissiveTexture, import_three2.SRGBColorSpace)
        );
      }
    ...
    loadNode(nodeIndex) {
      ...
      const skeletonPending =
        nodeDef.skin === void 0 ? Promise.resolve(null) : parser.getDependency('skin', nodeDef.skin);
    ...
    _createAnimationTracks(node, inputAccessor, outputAccessor, sampler, target) {
      ...
      const interpolation =
        sampler.interpolation !== void 0 ? INTERPOLATION[sampler.interpolation] : import_three2.InterpolateLinear;
  ...
  function computeBounds(geometry, primitiveDef, parser) {
    ...
    if (attributes.POSITION !== void 0) {
      ...
      if (min !== void 0 && max !== void 0) {
        box.set(new import_three2.Vector3(min[0], min[1], min[2]), new import_three2.Vector3(max[0], max[1], max[2]));
        if (accessor.normalized) {
  ...
  function addPrimitiveAttributes(geometry, primitiveDef, parser) {
    ...
    if (
      import_three2.ColorManagement.workingColorSpace !== import_three2.LinearSRGBColorSpace &&
