...
test.describe("Buttons Extended", () => {
  test.beforeEach(async ({ page }) => {
    ...
    try {
      ...
      if (await authScreen.isVisible({ timeout: 3000 }).catch(() => false)) {
        await page.evaluate(() => {
          document
            .querySelectorAll("#auth-screen, .auth-overlay")
            .forEach((el) => {
  ...
  test("#28 subscription modal opens", async ({ page }) => {
    const pricingBtn = page
      .locator('#btn-pricing, [data-action="pricing"], .pricing-trigger')
      .first();
    if (await pricingBtn.isVisible({ timeout: 5000 }).catch(() => false)) {
      await pricingBtn.click();
      await page.waitForTimeout(1000);
      const modal = page
        .locator("#pricing-modal, .pricing-modal, .modal")
        .first();
...
test.describe("Chat Streaming", () => {
  ...
  test("#49 POST /api/chat/stream empty message handling", async ({
    request,
  }) => {
    test.skip(!siteIsUp);
    const r = await request.post("/api/chat/stream", {
...
test.describe("Avatar Kira", () => {
  ...
  test("#52 Kira avatar loads", async ({ page }) => {
    ...
    const kiraBtn = page
      .locator('[data-avatar="kira"], #btn-kira, .avatar-switch-kira')
      .first();
...
test.describe("Voice TTS + STT", () => {
  ...
  test("#61 POST /api/listen with text (WebSpeech fallback)", async ({
    request,
  }) => {
    test.skip(!siteIsUp);
  ...
  test("#65 Multiple TTS requests all return audio (no intermittent)", async ({
    request,
  }) => {
    test.skip(!siteIsUp);
...
test.describe.serial("Auth Extended", () => {
  test("#80 POST /api/auth/refresh without token returns 400", async ({
    request,
  }) => {
    test.skip(!siteIsUp);
  ...
  test("#82 POST /api/auth/forgot-password valid email returns 200", async ({
    request,
  }) => {
    test.skip(!siteIsUp);
  ...
  test("#83 POST /api/auth/forgot-password nonexistent email returns 200", async ({
    request,
  }) => {
    test.skip(!siteIsUp);
    const r = await request.post("/api/auth/forgot-password", {
  ...
  test("#84 POST /api/auth/reset-password invalid token returns 401", async ({
    request,
  }) => {
    test.skip(!siteIsUp);
...
test.describe("AI Services Extended", () => {
  test("#117 POST /api/imagine returns full base64 image", async ({
    request,
  }) => {
    test.skip(!siteIsUp);
...
test.describe("Weather", () => {
  test("#119 POST /api/weather valid city returns data", async ({
    request,
  }) => {
    test.skip(!siteIsUp);
  ...
  test("#120 POST /api/weather unknown city returns 404", async ({
    request,
  }) => {
    test.skip(!siteIsUp);
    const r = await request.post("/api/weather", {
  ...
  test("#121 POST /api/weather without city returns 400", async ({
    request,
  }) => {
    test.skip(!siteIsUp);
...
test.describe("Geolocation", () => {
  test("#122 geolocation permission requested at startup", async ({
    page,
    context,
  }) => {
    test.skip(!siteIsUp);
...
test.describe("Payments (non-Stripe)", () => {
  test("#124 GET /api/payments/plans returns plan list", async ({
    request,
  }) => {
    test.skip(!siteIsUp);
  ...
  test("#125 GET /api/payments/status no auth returns guest", async ({
    request,
  }) => {
    test.skip(!siteIsUp);
...
test.describe("Media Extended", () => {
  ...
  test("#142 GET /api/news/public returns articles or empty", async ({
    request,
  }) => {
    test.skip(!siteIsUp);
...
test.describe("Admin Extended", () => {
  test("#148 GET /dashboard without admin secret returns 401+", async ({
    request,
  }) => {
    test.skip(!siteIsUp);
...
test.describe("Ticker", () => {
  test("#160 POST /api/ticker/disable without auth returns 401", async ({
    request,
  }) => {
    test.skip(!siteIsUp);
...
test.describe("Referral Extended", () => {
  test("#168 GET /api/referral/code with auth returns code", async ({
    request,
  }) => {
    test.skip(!siteIsUp);
    // Register + login
...
test.describe("UI Layout", () => {
  ...
  test("#171 POST /api/vision without image returns error", async ({
    request,
  }) => {
    test.skip(!siteIsUp);
...
test.describe.serial("E2E Flows", () => {
  test("#173 full auth: register → login → chat → logout", async ({
    request,
  }) => {
    test.skip(!siteIsUp);
...
test.describe("AI Simulations — Role-Based", () => {
  ...
  test("#182 Planner: real data vacation plan", async ({ request }) => {
    ...
    const r = await request.post("/api/chat", {
      data: {
        message:
          "Plan a 5-day vacation in Greece. Include real places and practical tips.",
        avatar: "kelion",
        language: "en",
      },
    });
  ...
  test("#184 Search-first: thinkTime > 0 on role request", async ({
    request,
  }) => {
    test.skip(!siteIsUp);
    const r = await request.post("/api/chat", {
...
test.describe("Brain Intelligence", () => {
  test("#185 chain-of-thought: thinkTime on complex request", async ({
    request,
  }) => {
    test.skip(!siteIsUp);
    const r = await request.post("/api/chat", {
      data: {
        message:
          "What is the weather in Bucharest and what are the latest tech news?",
        avatar: "kelion",
        language: "en",
      },
    });
  ...
  test("#191 multi-tool: weather + search in one query", async ({
    request,
  }) => {
    test.skip(!siteIsUp);
    const r = await request.post("/api/chat", {
      data: {
        message:
          "How is the weather in Paris and what are the top restaurants there?",
        avatar: "kelion",
        language: "en",
      },
    });
  ...
  test("#192 GET /api/brain diagnostics (admin blocked)", async ({
    request,
  }) => {
    test.skip(!siteIsUp);
...
test.describe("Persona & Emotions", () => {
  ...
  test('#199 Proactive: "going outside" triggers weather suggestion', async ({
    request,
  }) => {
    test.skip(!siteIsUp);
    const r = await request.post("/api/chat", {
...
test.describe("Persistent Memory", () => {
  ...
  test("#206 memory isolation: no auth user has no memory", async ({
    request,
  }) => {
    test.skip(!siteIsUp);
    const r = await request.post("/api/chat", {
