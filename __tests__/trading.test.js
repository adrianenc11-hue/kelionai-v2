...
describe("calculateRSI", () => {
  test("returns value between 0 and 100 with known inputs", () => {
    const prices = [
      44, 44.34, 44.09, 43.61, 44.33, 44.83, 45.1, 45.15, 43.61, 44.33, 44.83,
      45.1, 45.15, 43.61, 44.33,
    ];
  ...
  test("mixed prices → returns numeric between 0 and 100", () => {
    const prices = [
      100, 102, 101, 103, 100, 99, 101, 104, 102, 103, 105, 104, 106, 107, 105,
      108,
    ];
    const { value } = calculateRSI(prices, 14);
...
describe("analyzeSentiment", () => {
  test("bullish text → score > 0", () => {
    const { score } = analyzeSentiment(
      "Bitcoin rally surge bullish breakout buy",
    );
  ...
  test("bearish text → score < 0", () => {
    const { score } = analyzeSentiment(
      "market crash bearish drop sell fear panic",
    );
